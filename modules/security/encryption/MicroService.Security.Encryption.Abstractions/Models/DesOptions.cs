...
/// <summary>
/// Provides values to use to set Data Encryption Standard (DES) options.
/// </summary>
public sealed class DesOptions : SymmetricAlgorithmOptions
{
    ...
    public DesOptions(int keySize, int blockSize, int derivationIterations, CipherMode cipherMode, PaddingMode paddingMode)
    {
        KeySize = keySize;
        BlockSize = blockSize;
    ...
    /// <summary>
    /// Provides a copy of the DesOptions with default values.
    /// </summary>
    public static DesOptions Default => new();
