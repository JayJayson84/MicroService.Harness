...
/// <summary>
/// Provides values to use to set options for the cryptographic service provider (CSP) version of the RC2 algorithm.
/// </summary>
public sealed class Rc2Options : SymmetricAlgorithmOptions
{

    #region Constants

    public const int DEFAULT_KEY_SIZE = 64;
    ...
    public Rc2Options(int keySize, int blockSize, int derivationIterations, CipherMode cipherMode, PaddingMode paddingMode)
    {
        KeySize = keySize;
        BlockSize = blockSize;
    ...
    /// <summary>
    /// Provides a copy of the Rc2Options with default values.
    /// </summary>
    public static Rc2Options Default => new();
